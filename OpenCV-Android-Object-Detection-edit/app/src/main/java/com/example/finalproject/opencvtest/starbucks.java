...
public class starbucks extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private void initializeOpenCVDependencies() throws IOException {
        ...
        InputStream istr = assetManager.open("starbucks.jpeg");
    ...
    public void updateUI(final int match, final int present){
        runOnUiThread(new Runnable(){
            ...
            public void run(){
                ...
                sum_match +=match;
                if(present ==0){
                    detected.setText("Not Starbucks");
                }
                if(match>50){
                    detected.setText("Not Starbucks");
                }
                else{
                    detected.setText("Starbucks");
                   // System.exit(0);
                }
            }
        });
